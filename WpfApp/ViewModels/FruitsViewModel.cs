...
{
  public class FruitsViewModel:ViewModelBase
    {
        ...
        public FruitsViewModel(IServiceWrapper servicewrapper)
        {
            Product = new Product();     
        ...
        public void GetAll()
        {
            ...
            _servicewrapper.prodService.GetAllProductsByCategory(_servicewrapper.catService.GetCategory("Fruits")).ForEach(data => Product.ProductsDTO.Add(new ProductDTO()
            {
                Id = data.Id,
